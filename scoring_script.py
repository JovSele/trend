# Prve scanovanie vystupneho suboru z leng.org
# Redukcia velkeho poctu zaznamov na Percentilové Filtrovanie  - pozri riadok 21 - nastavenie percentilu
# Spustenie: python scoring_script.py
